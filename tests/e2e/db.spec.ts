...
// Auth gating for these endpoints is enforced at the edge (Cloudflare Access)
// and re-verified in the route handlers; this file covers what happens after
// auth: markSubmissionRead, softDeleteSubmission, and the soft-delete exclusion
// in getAllSubmissions. Tests import lib/db directly rather than going through
// the HTTP API, which would require a CF Access JWT.
